...
<div class="top_panel_save">
    <div class="menu_save">
        <a class="save" id ="save"><span>Save</span></a>
        ...
        <div class="news_list">
            ...
            <div class="news">
                <div class="checkbox_container">
                    ...
                    <input type="checkbox" class="checkbox" id="checkbox${items.indexOf(item)}" value="${items.indexOf(item)}" name="news"/>
                    <label for="checkbox${items.indexOf(item)}"></label>
                </div>
